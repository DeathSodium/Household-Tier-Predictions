...
def save_final_tuned_lgbm(split_dir, model_dir):
    ...
    }, os.path.join(model_dir, "tuned_lgbm_model.joblib"))
    print(f"Tuned LightGBM model saved to {model_dir}")

if __name__ == "__main__":
    split_dir = r"data/processed/split"
    model_dir = r"models/tuned_lgbm"
    save_final_tuned_lgbm(split_dir, model_dir)
